    ...
    <div class="relative">
      ...
      >
        ...
        <p class="mt-5 mx-auto max-w-prose text-xl text-gray-500">
          Retrouvez les topos de randonnées en canoë kayak. L'idéal pour
          s'évader le long d'une rivière le temps d'un week end de deux ou trois
          jours.
        </p>
      </div>
      <div
