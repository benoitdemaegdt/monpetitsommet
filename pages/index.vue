<template>
  <div class="pt-12 w-full h-screen mx-auto flex flex-col justify-center items-center">
    <div class="w-full relative flex flex-col justify-center" style="height: 90%;">
      <nuxt-image src="/img/vercors.png" class="landing-image" />
      <div class="grid grid-cols-2 gap-4 backgound" style="height: 80%;">
        <div />
        <div class="flex flex-col justify-center">
          ...
          <p class="mt-6 w-3/4 text-gray-100 text-base md:text-xl lg:text-2xl font-semibold">
