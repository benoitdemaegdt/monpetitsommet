    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      <div class="text-lg max-w-prose mx-auto">
        <h1>
          ...
          <span
            ...
            >La traversée du Vercors par le balcon est
          </span>
        </h1>
        <p class="mt-8 text-xl text-gray-500 leading-8">
          La traversée du Vercors (par le balcon Est) est certainement l'une des
          plus belles et majestueuses randonnées de ce massif. L'itinéraire est
          varié et sportif : une bonne distance, deux sommets (le Grand Veymont
          et la Grande Moucherolle), des passages techniques et exposés, des
          secteurs denses en animaux sauvages. Le tout pour une inoubliable
      ...
      <div class="mt-6 prose prose-emerald prose-lg text-gray-500 mx-auto">
        <img
          ...
          src="https://res.cloudinary.com/monpetitsommet/image/upload/f_auto,q_auto/v1604305406/vercors/randonnees/traversee-vercors-balcon-est/intro_xhbx3y.png"
          alt="snowkite"
          width="1310"
          height="873"
        />
        ...
        <p>
          ...
          petit hameau situé au pied du Mont Aiguille. Le plus simple pour s'y
          rendre est de prendre le TER qui fait la liaison entre Grenoble et Gap
          et de s'arrêter à la gare de Clelles-Mens (environ 10 trains/j dans
          chaque sens). À partir de cette gare il y a deux possibilités pour
