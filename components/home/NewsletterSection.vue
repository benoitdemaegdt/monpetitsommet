<template>
  <div class="bg-white py-16 sm:py-24">
    <div class="relative sm:py-16">
      ...
      >
        <div
          class="relative rounded-2xl px-6 py-10 bg-emerald-600 overflow-hidden shadow-xl sm:px-12 sm:py-20"
        >
          <div
            aria-hidden="true"
          ...
          >
            ...
            >
              <path
                class="text-emerald-500 text-opacity-40"
                fill="currentColor"
                d="M-82.673 72l1761.849 472.086-134.327 501.315-1761.85-472.086z"
              />
              <path
                class="text-emerald-700 text-opacity-40"
                fill="currentColor"
          ...
          <div class="relative">
            <div class="sm:text-center">
              ...
              >
                Newsletter 100% aventure
              </h2>
              <p class="mt-6 mx-auto max-w-2xl text-lg text-emerald-200">
                Recevez directement par email le topo des nouvelles aventures
                que nous publions sur le site. Rando, escalade ou snowkite : il
